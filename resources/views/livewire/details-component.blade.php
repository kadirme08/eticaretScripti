                ...
                <div class="row">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="submit" class="button button-add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})">Sepete Ekle</button>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('detail.product',['slug'=>$rproduct->slug])}}" tabindex="0">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{route('detail.product',['slug'=>$rproduct->slug])}}" tabindex="0">{{$product->name}}</a></h2>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title mb-10">Yeni Ürünler</h5>
                                <div class="bt-1 border-color-1"></div>
                            </div>
