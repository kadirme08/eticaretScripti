                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-xl-4 col-sm-6">
                                <div class="mt-2">
                                  Sizin için  <b>   {{count( $searchProduct)}}</b> Ürün Listelendi.
                                </div>
                            </div>
                                ...
                                <form class="mt-4 mt-sm-0 float-sm-right form-inline" method="post" action="{{route('searchProduct')}}">
                                    ...
                                    <div class="search-box mr-2">
                                        <div class="position-relative">
                                            <input type="text" class="form-control border-0" name="urun_name" placeholder="Aradıgınız Ürünü Girin" value="{{$q}}">
