                ...
                <div class="col-xl-6 col-lg-4">
                    <div class="text-center">
                        <div id="news-flash" class="d-inline-block">
                            <ul>
                                <li>Yaz İndirimi Başladı %50'ye varan İndirimler <a href="shop.html">Ürünleri Gör</a></li>
                                <li>Kış İndirimi Başladı</li>
                                <li>Marka Ürünlerde %35 İndirim <a href="shop.html">Ürünü GÖr</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="header-action-2">
                            @auth
                                <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                                    <nav>
                                        <ul>
                                            <li><a href="#"> <i class="fi-rs-user " style="font-size: 15px;  margin-right: 7px"></i> {{Auth::user()->name}} <i class="fi-rs-angle-down"></i></a>
                                                <ul class="sub-menu">
                                                    @if(Auth::user()->utype)
                                                    <li><a href="{{route('user.dashboard')}}">Hesabım</a></li>
                                                        @else
                                                        <li><a href="{{route('admin.dashboard')}}">Hesabım</a></li>
                                                    @endif
                            ...
                            @else
                                <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                                    <nav>
                                        <ul>
                                            <li><a href="#"> <i class="fi-rs-user " style="font-size: 15px; margin-right: 7px"></i> Giriş Yap <i class="fi-rs-angle-down"></i></a>
                                                <ul class="sub-menu">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul style="margin-left: 250px">
                                <li><a class="active" href="{{route('home.index')}}">Yeni Sezon </a></li>
                                <li class="position-static"><a href="#" style="margin-left: 20px">ERKEK<i class="fi-rs-angle-down"></i></a>
                               <!--     <ul class="mega-menu">
                                ...
                                <li class="position-static"><a href="#" style="margin-left: 20px">KADIN <i class="fi-rs-angle-down"></i></a>
                                  <!--  <ul class="mega-menu">
                                        <li class="sub-mega-menu sub-mega-menu-width-22">
                                            <a class="menu-title" href="#">Women's Fashion</a>
                                            <ul>
                                ...
                                <li class="position-static"><a href="#" style="margin-left: 20px">ÇOCUK <i class="fi-rs-angle-down"></i></a>
                                    <ul class="mega-menu">
                                        <li class="sub-mega-menu sub-mega-menu-width-22">
                                            <a class="menu-title" href="#">Women's Fashion</a>
                                            <ul>
                                ...
                                <li class="position-static"><a href="# " style="margin-left: 20px">MARKA <i class="fi-rs-angle-down"></i></a>
                                   <!-- <ul class="mega-menu">
                                        <li class="sub-mega-menu sub-mega-menu-width-22">
                                            <a class="menu-title" href="#">Women's Fashion</a>
                                            <ul>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    &copy; <strong class="text-brand"></strong> {{date('Y')}}Tüm Hakları Saklıdır.
                </p>
            </div>
        </div>
    </div>
